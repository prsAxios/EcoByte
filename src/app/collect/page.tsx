  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
        1. Confirm if the waste type matches: ${selectedTask.foodType}
        2. Estimate if the quantity matches: ${selectedTask.expiryDate}
      ...
      try {
        ...
        setVerificationResult({
          foodTypeMatch: parsedResult.wasteTypeMatch,
          expiryDateMatch: parsedResult.quantityMatch,
          confidence: parsedResult.confidence
        })
        setVerificationStatus('success')
        
        if (parsedResult.wasteTypeMatch && parsedResult.confidence > 0) {
