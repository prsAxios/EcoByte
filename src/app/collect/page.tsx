...
//       const prompt = `You are an expert in waste management and recycling. Please analyze the provided image and respond based on the criteria below:

//     Confirm if the waste type in the image matches the specified type: ${selectedTask.foodType}.
//     Estimate if the quantity in the image aligns with the expected amount: ${selectedTask.expiryDate}.
//     Provide your confidence level for this assessment as a value between 0 and 1.

// Respond only in the following JSON format:

//     {
//       "foodTypeMatch": true/false,
//       "expiryDateMatch": true/false,
...
//           foodTypeMatch: parsedResult.foodTypeMatch,
//           expiryDateMatch: parsedResult.expiryDateMatch,
...
//         console.log(parsedResult.foodTypeMatch && parsedResult.confidence > 0);

//         if (parsedResult.foodTypeMatch && parsedResult.confidence > 0) {
...
Respond only in the following JSON format:
    ...
    try {
      ...
      if (
        parsedResult.foodTypeMatch ||
        parsedResult.expiryDateMatch ||
        parsedResult.confidence > 0.8 // or set your preferred confidence threshold
      ) {
        await handleStatusChange(selectedTask.id, "verified");
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2 text-sm text-gray-600 mb-3">
                  <div className="flex items-center relative">
                    ...
                    >
                      {task.foodType.length > 8
                        ? `${task.foodType.slice(0, 8)}...`
                        : task.foodType}
                    </span>
